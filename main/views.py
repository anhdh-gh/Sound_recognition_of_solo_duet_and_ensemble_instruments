...
from main.util import save_file, count_folder, get_real_path, save_features, export_to_excel, delete_file, \
    get_relative_path, get_real_folder_path, save_file_input, extract_vector_features, calculate
...
class HomeHandler(View):
    ...
    def post(self, request):
        ...
        # Thực hiện tính toán và gán nhãn
        files, file_result = calculate(features)
